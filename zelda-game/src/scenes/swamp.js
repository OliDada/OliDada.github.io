...
export default async function swamp(k) {
    ...
    const mapData = await fetchMapData('./assets/maps/swamp.json');
    ...
    entities.player.onCollide('swamp-exit', () => {
        gameState.setPreviousScene('swamp');
        k.go('forest-east');
    });
